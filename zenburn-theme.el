...
(custom-theme-set-faces
 ...
 `(zenburn-background ((t (:background ,zenburn-bg))) t)
 `(zenburn-background-1 ((t (:background ,zenburn-bg+1))) t)
 `(zenburn-background-2 ((t (:background ,zenburn-bg+2))) t)
 `(zenburn-primary-1 ((t (:foreground ,zenburn-yellow-1 :weight bold))) t)
 `(zenburn-primary-2 ((t (:foreground ,zenburn-orange :weight bold))) t)
 '(zenburn-primary-3 ((t (:foreground "#dfdfbf" :weight bold))) t)
 '(zenburn-primary-4 ((t (:foreground "#dca3a3" :weight bold))) t)
 '(zenburn-primary-5 ((t (:foreground "#94bff3" :weight bold))) t)
 '(zenburn-highlight-damp ((t (:foreground "#88b090" :background "#2e3330"))) t)
 '(zenburn-highlight-alerting ((t (:foreground "#e37170" :background
 "#332323"))) t)
 '(zenburn-highlight-subtle ((t (:background "#464646"))) t)
 '(zenburn-lowlight-1 ((t (:foreground "#606060"))) t)
 '(zenburn-lowlight-2 ((t (:foreground "#708070"))) t)
 `(zenburn-yellow ((t (:foreground ,zenburn-yellow))) t)
 `(zenburn-orange ((t (:foreground ,zenburn-orange))) t)
 `(zenburn-red ((t (:foreground ,zenburn-red))) t)
 `(zenburn-red-1 ((t (:foreground ,zenburn-red-1))) t)
 `(zenburn-red-2 ((t (:foreground ,zenburn-red-2))) t)
 `(zenburn-red-3 ((t (:foreground ,zenburn-red-3))) t)
 `(zenburn-red-4 ((t (:foreground ,zenburn-red-4))) t)
 `(zenburn-green-1 ((t (:foreground ,zenburn-green-1))) t)
 `(zenburn-green ((t (:foreground ,zenburn-green))) t)
 `(zenburn-green+1 ((t (:foreground ,zenburn-green+1))) t)
 `(zenburn-green+2 ((t (:foreground ,zenburn-green+2))) t)
 `(zenburn-green+3 ((t (:foreground ,zenburn-green+3))) t)
 `(zenburn-green+4 ((t (:foreground ,zenburn-green+4))) t)
 `(zenburn-blue ((t (:foreground ,zenburn-blue))) t)
 `(zenburn-blue-1 ((t (:foreground ,zenburn-blue-1))) t)
 `(zenburn-blue-2 ((t (:foreground ,zenburn-blue-2))) t)
 `(zenburn-blue-3 ((t (:foreground ,zenburn-blue-3))) t)
 `(zenburn-blue-4 ((t (:foreground ,zenburn-blue-4))) t)
 '(zenburn-title ((t (:inherit variable-pitch :weight bold))) t)
 ...
 ;; Hydra
 `(hydra-face-red ((t (:foreground "#e37170" :background ,zenburn-bg :weight bold))))
 `(hydra-face-blue ((t (:weight bold))))
 `(hydra-face-amaranth ((t (:weight bold :foreground ,zenburn-red-3))))
 `(hydra-face-pink ((t (:weight bold :foreground ,zenburn-magenta))))
 `(hydra-face-teal ((t (:weight bold :foreground ,zenburn-blue-2)))))
