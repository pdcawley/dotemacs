  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
          ...
          '(isearch-fail ((t (:inherit font-lock-warning))))
          ...
          '(org-agenda-structure ((t (:inherit zenburn-primary-5))))
          ...
          '(woman-unknown ((t (:inherit zenburn-yellow))))
