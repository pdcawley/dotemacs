...
;;   (global-set-key (kbd "C-c C-S-F") 'iy-go-to-char-backward)
;;   (global-set-key (kbd "C-c ;") 'iy-go-to-char-continue)
;;   (global-set-key (kbd "C-c C-;") 'iy-go-to-char-continue)
;;   (global-set-key (kbd "C-c ,") 'iy-go-to-char-continue-backward)
;;   (global-set-key (kbd "C-c C-,") 'iy-go-to-char-continue-backward))

(when (require 'fastnav nil 'noerror)
