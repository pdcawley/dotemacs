  ...
  (defun bindings|expand-define-prefix (desc key docstr)
    (let* ((descname (symbol-name desc))
      ...
      `(progn
         ...
         (general-define-key
          ,leader-variable-name '(nil :which-key ,(symbol-name desc))))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package general
    ...
    (bindings|define-prefix mark "m" "mark/mc")
...
#+BEGIN_SRC emacs-lisp
  ...
  (req-package counsel
    ...
    (pdc|with-leader
     ...
     "o j" '(counsel-org-goto :which-key "goto")
     "o J" '(counsel-org-goto-all :which-key "goto-all"))
    :init
...
#+BEGIN_SRC emacs-lisp
  ...
  (req-package pdc-helpers
    ...
    (pdc|with-leader
     ...
     "C-M-|"  'pdc|align-last-sexp
     "C-M-\\" 'pdc|align-last-sexp

     "'"      'pdc|quote-behind
     "\""     'pdc|doublequote-behind

     ;; operate on file and buffer, so put beneath both leaders
     "f R"    'pdc|rename-file-and-buffer
     "b R"    'pdc|rename-file-and-buffer   
     "f M"    'pdc|move-buffer-file
     "b M"    'pdc|move-buffer-file

     "e i"    'pdc|visit-ielm
     "e R"    'pdc|eval-and-replace)
    :init
