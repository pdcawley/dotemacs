...
(define-key input-decode-map  "\e[1;9C"      [M-left])
(define-key input-decode-map "\e[1;10C"    [S-M-left])
(define-key input-decode-map "\e[1;14C"    [C-M-left])
(define-key input-decode-map "\e[1;15C"  [S-C-M-left])
(define-key input-decode-map  "\e[1;9D"     [M-right])
(define-key input-decode-map "\e[1;10D"   [S-M-right])
(define-key input-decode-map "\e[1;14D"   [C-M-right])
(define-key input-decode-map "\e[1;15D" [S-C-M-right])
